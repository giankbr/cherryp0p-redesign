      ...
      <main className="flex-1 bg-black">
        ...
        <section className="relative h-[60vh] flex items-center">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl">
              Cherrypop Festival adalah panggung bagi kreativitas subkultur anak muda Indonesia.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h3 className="text-4xl font-bold mb-6">CHERRYPOP FESTIVAL</h3>
                <div className="space-y-4">
                  <p>
                    Cherrypop, festival musik tahunan di Yogyakarta yang digagas oleh Swasembada Kreasi, adalah panggung
                    bagi kreativitas subkultur anak muda. Dari musisi hingga pembuat film, dari perupa hingga pegiat
                    kuliner, berbagai disiplin bertemu untuk berkreasi, berdialog, dan berbagi energi.
                  </p>
                  <p>
                    Berawal dari sebuah gig kecil di tahun 2018, Cherrypop berkembang menjadi salah satu festival musik
                    independen terbesar di Indonesia. Dengan semangat DIY (Do It Yourself) dan kolaborasi, festival ini
                    terus tumbuh dan menjadi rumah bagi berbagai ekspresi kreatif.
                  </p>
                  <p>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="border-2 border-primary p-8">
                ...
                <p className="text-lg">
                  Menjadi platform yang menghubungkan, menginspirasi, dan memberdayakan komunitas kreatif di Indonesia
                  melalui pengalaman festival yang inklusif dan berkelanjutan.
                </p>
              </div>
              <div className="border-2 border-white p-8">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span>
                      Menciptakan ruang yang aman dan inklusif bagi ekspresi kreatif dari berbagai latar belakang dan
                      disiplin.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2">—</span>
                    <span>
                      Memfasilitasi kolaborasi antara seniman, musisi, dan kreator untuk mendorong inovasi dan
                      pertukaran ide.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-primary mr-2">—</span>
                    <span>
                      Mempromosikan praktik berkelanjutan dalam penyelenggaraan festival dan mendukung ekonomi lokal.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            <h3 className="text-4xl font-bold mb-12">THE PEOPLE BEHIND CHERRYPOP</h3>
        ...
        <section className="py-16 bg-accent/5">
          <div className="container mx-auto px-4">
            ...
            <h3 className="text-4xl font-bold mb-12">OUR JOURNEY</h3>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            <h3 className="text-4xl font-bold mb-12">OUR COLLABORATORS</h3>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {Array.from({ length: 8 }).map((_, index) => (
                <div
                  key={index}
                  className="flex items-center justify-center p-6 bg-accent/5 border border-border h-32 hover:border-primary transition-colors"
                >
                  <Image
