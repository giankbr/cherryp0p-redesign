...
export function About() {
  ...
  return (
    <section id="about" className="py-20 md:py-32 relative overflow-hidden noise-bg">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 order-1 lg:order-2">
            <h2 className="about-title text-3xl md:text-4xl font-bold mb-8">
              <span className="gradient-text">Tentang</span> Cherrypop
            </h2>
            <div className="space-y-6">
              ...
              <p className="about-content text-lg">
                Festival ini adalah simbol semangat kolaborasi dan energi kreatif yang terus berkembang di Yogyakarta
                dan Indonesia.
              </p>
            </div>
          </div>
